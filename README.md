...
Execute the notebook `Navigation.ipynb`. Initiate the Unity environment and the Agent. The last cell loads the default weights and executes the network. Set the flag train to `TRUE` to retrain the model. Further details can be found [here](Report.md)
